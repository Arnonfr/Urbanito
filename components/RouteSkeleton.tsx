    ...
    <div className={`fixed inset-0 z-[100] bg-slate-50 flex flex-col lg:flex-row ${isHe ? 'lg:flex-row-reverse' : ''}`}>
      ...
      <div className="flex-1 relative bg-slate-100/50">
         ...
         <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-8">
            <div className="w-20 h-20 bg-white rounded-full flex items-center justify-center shadow-xl mb-8 animate-bounce">
               <MapPinned className="text-emerald-500" size={32} />
            </div>
         ...
         <div className="lg:hidden fixed inset-x-0 bottom-0 h-[40vh] bg-white rounded-t-[10px] p-8 space-y-6 shadow-[0_-10px_40px_rgba(0,0,0,0.1)]">
