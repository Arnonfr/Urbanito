...
const App: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const initApp = async () => {
      try {
        // NOTE: User state is set by onAuthStateChange (INITIAL_SESSION event below).
        // Calling getSession() here was redundant and caused AbortError in production.
          ...
          <Routes>
            ...
            <Route path="/library" element={
              <LibraryPage
                ...
                recentGlobalRoutes={recentGlobalRoutes}
                viewingCity={viewingCity}
                viewingCityData={viewingCityData}
                citySpecificRoutes={citySpecificRoutes}
                isLoadingCityRoutes={isLoadingCityRoutes}
                onOpenRoute={handleLoadSavedRoute}
                onCitySelect={handleCitySelect}
                onClearViewingCity={() => setViewingCity(null)}
              />
            } />
