-- Add share_teaser column to routes table
ALTER TABLE routes ADD COLUMN IF NOT EXISTS share_teaser TEXT;

-- Update save_generated_route RPC to include share_teaser
...
BEGIN
    ...
    LOOP
        ...
        -- Insert/Get POI (Deduplication by proper coordinates/name)
